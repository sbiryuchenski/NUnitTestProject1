...
namespace NUnitTestProject1
{
    ...
    class TestElements:BaseTest
    {
        ...
        public void Test1()
        {
            ...
            move.ClickAndHold(dragelement).MoveToElement(point1).Release(dragelement).Perform();
            Thread.Sleep(100);
            move.ClickAndHold(dragelement).MoveToElement(point2).Release(dragelement).Perform();
            Thread.Sleep(100);
            move.ClickAndHold(dragelement).MoveToElement(point3).Release(dragelement).Perform();
            Thread.Sleep(100);
